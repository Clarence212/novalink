...
export const FacilityReservations = () => {
  const { currentUser, currentHomeowner, reservations, facilities, homeowners, addReservation, updateReservationStatus, isRestricted } = useApp();
  ...
  const handleSubmit = (e) => {
    ...
    setForm({ facilityId: 'f1', date: '', timeSlot: '', purpose: '' });
    setShowForm(false);
  };
